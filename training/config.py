...
def build_model_config(cfg: dict) -> dict:
    ...
    config = {
        ...
        'mix_recon_weight': model_cfg.get('mix_recon_weight', 0.0),
        ...
        'encoder_strides': tuple(model_cfg.get('encoder_strides', (6, 8, 8, 8))),
        'encoder_channels': tuple(model_cfg.get('encoder_channels', (64, 96, 128, 128))),
        'encoder_initial_channels': model_cfg.get('encoder_initial_channels', 32),
        # v15 waveform decoder
        'decoder_strides': tuple(model_cfg.get('decoder_strides', (8, 8, 8, 6))),
        'decoder_channels': tuple(model_cfg.get('decoder_channels', (128, 96, 64, 32))),
        # v15 recon recipe (DAC-style)
        'mel_l1_weight': model_cfg.get('mel_l1_weight', 15.0),
        'mrstft_mag_l1_weight': model_cfg.get('mrstft_mag_l1_weight', 1.0),
        'latent_l2_weight': model_cfg.get('latent_l2_weight', 0.001),
    }
    # n_freq_bins was a v14-era derived param; unused by v15 but computed for legacy callers.
    _ = n_freq_bins
