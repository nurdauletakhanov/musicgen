...
tighter compression too, and it restores level as well as shape. An
...
\begin{enumerate}
  ...
  \item Generalization against matched controls: from-scratch training at
  $2\times$ tighter compression, and a re-run on a consistency-model
