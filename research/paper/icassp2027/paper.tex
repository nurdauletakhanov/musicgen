...
noise per call. Decoding the \emph{same} latent twice, with no latent operation
at all, scores $-1.8$\,dB under independent noise and $+114$\,dB under shared
noise, so the decoder's sampling alone accounts for most of the collapse. \figref{fig:protocol}
