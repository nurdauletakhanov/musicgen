...
and decoder class (deterministic GAN versus consistency model). What we add is
not the principle but its analysis: which ingredient carries the effect, a
...
SI-SDR), which is what our phase-coherence finding predicts for a consistency
decoder.
