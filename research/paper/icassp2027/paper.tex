...
Conclusions below are conditional on those comparators; the design is not a
full factorial. Three observations drive the rest of the paper.
...
($\ell_\mathrm{lat}$ $0.072$). Joint training performs best among the tested
configurations; the decoder alone recovers most of the effect.
