...
rates. We therefore recommend reporting latent arithmetic against a declared origin
...
intervals are conditional on these checkpoints; exact recovery holds only
for an affine encoder; experiments are mono with no listening test.
